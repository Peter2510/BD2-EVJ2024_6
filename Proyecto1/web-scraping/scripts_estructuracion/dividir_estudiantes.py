...
input_file = '../ArchivosCSVDivididos/estudiantes_solo.csv'  # Reemplaza con la ruta de tu archivo de texto
output_csv = 'nombre_estudiantes_divididos.csv'  # Nombre del archivo CSV de salida
