...
try:
    with open(input_file, 'r', encoding='utf-8') as file:
        ...
        if headers != ['Id','FirstName', 'LastName']:
        ...
        for row in reader:
            ...
            data.append([ids,first_names, last_names, email, password, date_of_birth, last_changes, email_confirmed])
